...
extension Encoder {
    public mutating func encode(_ value: MessagePack) throws {
        ...
        case let .binary(value): try encode(binary: value)
    ...
    public mutating func encode(
        _ dictionary: [MessagePack : MessagePack]
    ) throws {
    ...
    public mutating func encode(binary: [UInt8]) throws {
    ...
    public mutating func encode(_ value: Int16) throws {
        ...
        case let value where value >= -0x7f:
            try encode(Int8(truncatingBitPattern: value))
        default:
            try write(code: 0xd1)
            try write(value)
        }
    ...
    public mutating func encode(_ value: Int32) throws {
        ...
        case let value where value >= -0x7fff:
            try encode(Int16(truncatingBitPattern: value))
        default:
            try write(code: 0xd2)
            try write(value)
        }
    ...
    public mutating func encode(_ value: Int64) throws {
        ...
        case let value where value >= -0x7fff_ffff:
            try encode(Int32(truncatingBitPattern: value))
        default:
            try write(code: 0xd3)
            try write(value)
        }
    ...
    public mutating func encode(_ value: UInt16) throws {
        ...
        case let value where value <= 0xff:
            try encode(UInt8(truncatingBitPattern: value))
        default:
            try write(code: 0xcd)
            try write(value)
        }
    ...
    public mutating func encode(_ value: UInt32) throws {
        ...
        case let value where value <= 0xffff:
            try encode(UInt16(truncatingBitPattern: value))
        default:
            try write(code: 0xce)
            try write(value)
        }
    ...
    public mutating func encode(_ value: UInt64) throws {
        ...
        case let value where value <= 0xffff_ffff:
            try encode(UInt32(truncatingBitPattern: value))
        default:
            try write(code: 0xcf)
            try write(value)
        }
